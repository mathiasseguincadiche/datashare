#!/usr/bin/env bash
# =============================================================
# apply-all.sh — Fiche 9 COMPLET + Corrections Figma v2
# Exécuter depuis la racine du projet /datashare : bash apply-all.sh
# =============================================================
set -euo pipefail

BASE="frontend/src"

echo "🚀 Application complète — 16 fichiers (Fiche 9 + Figma v2)"
echo "=============================================================="
...
# 1) RegisterForm.tsx
# =============================================================
echo "🔴 1/16 — components/auth/RegisterForm.tsx"
...
# 2) RegisterPage.tsx
# =============================================================
echo "🔴 2/16 — pages/RegisterPage.tsx"
...
# =============================================================
echo "🔴 3/16 — components/ui/Switch.tsx (nouveau)"
...
# =============================================================
# 4) FileCard.tsx (v2 — icônes + Accéder)
# =============================================================
echo "🔴 4/16 — components/files/FileCard.tsx (v2)"
...
# 5) FileList.tsx
# =============================================================
echo "🔴 5/16 — components/files/FileList.tsx"
...
# 6) HistoryPage.tsx
# =============================================================
echo "🔴 6/16 — pages/HistoryPage.tsx"
...
# =============================================================
echo "🟠 7/16 — components/layout/Navbar.tsx (v2)"
...
# 9) LoginForm.tsx
# =============================================================
echo "🟠 9/16 — components/auth/LoginForm.tsx"
...
# 10) UploadForm.tsx
# =============================================================
echo "🟠 10/16 — components/files/UploadForm.tsx"
...
# 11) UploadPage.tsx
# =============================================================
echo "🟠 11/16 — pages/UploadPage.tsx"
...
# 12) Footer.tsx
# =============================================================
echo "🟠 12/16 — components/layout/Footer.tsx"
...
# =============================================================
echo "🔴 13/16 — pages/HomePage.tsx (nouveau)"
...
# =============================================================
# 15) App.css — COMPLET v2
# =============================================================
echo "🎨 15/16 — App.css (remplacement complet v2)"
...
.shell__content { padding: 1rem 0 3rem; }
...
.panel--hero {
  background: linear-gradient(145deg, rgba(255,255,255,0.92), rgba(246,243,236,0.78)),
  linear-gradient(135deg, rgba(16,107,97,0.15), rgba(240,165,0,0.12));
}

.panel--success {
  background: linear-gradient(180deg, rgba(245,255,250,0.95) 0%, rgba(255,255,255,0.88) 100%);
}
...
.panel--download {
  ...
  margin: 2rem auto;
  padding: 2rem;
  background: linear-gradient(145deg, rgba(255,255,255,0.96), rgba(240,248,246,0.9)),
...
.panel__meta h2,
.panel--hero h1,
.auth-page h1 { margin: 0 0 0.65rem; }
...
.auth-page__intro p { color: var(--muted); }
.auth-page__aside { margin: 0; color: var(--muted); }
...
.form-card--wide { gap: 1.25rem; }

.field { display: grid; gap: 0.4rem; }
.field__label { font-weight: 600; }
.field__hint, .field__error { font-size: 0.9rem; }
...
.input--error { border-color: rgba(182, 71, 53, 0.45); }
...
.dropzone {
  ...
  background: linear-gradient(180deg, rgba(255,255,255,0.76) 0%, rgba(240,248,246,0.9) 100%);
}

.dropzone__caption { display: block; margin-bottom: 0.75rem; font-weight: 600; }
.dropzone__meta { margin: 0.75rem 0 0; color: var(--muted); }
...
.file-card__content h3 { margin: 0 0 0.35rem; }
.file-card__content p { margin: 0.15rem 0; color: var(--muted); }
...
.file-card__lock { font-size: 0.85em; margin-left: 0.3rem; }
.file-card__lock-badge { font-size: 0.85rem; align-self: center; }
.file-card--expired { opacity: 0.55; }
.file-card--expired h3 { text-decoration: line-through; }
...
.home-landing h1 { font-size: 1.6rem; color: var(--text); }
...
.download-form { display: grid; gap: 1rem; margin-top: 1.25rem; }
.download-success { display: grid; gap: 1rem; margin-top: 1.25rem; }
...
@media (max-width: 720px) {
  .shell__header { align-items: flex-start; flex-direction: column; }
  .file-card { align-items: flex-start; flex-direction: column; }
  .file-card__actions { width: 100%; justify-content: stretch; }
  .file-card__actions .button { width: 100%; }
  .panel--download { margin: 1rem auto; }
}
EOF
...
# =============================================================
echo "🔧 16/16 — pages/DownloadPage.tsx (refonte Figma v2)"
